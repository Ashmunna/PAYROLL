                ...
                <div class="col-lg-7">
                    <div class="banner_text">
                        <div class="banner_text_iner">  
                            <h5 style="color: black; background: white; font-family: monospace; margin-left: 50px; ">Best way to manage your pay</h5>
                            <h1 style="color: deeppink; margin-left: 50px;">Jarvis Payroll Management System</h1>
                        </div>
                    </div>
                </div>
            </div>
